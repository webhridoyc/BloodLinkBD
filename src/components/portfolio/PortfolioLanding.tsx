    ...
    <div className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen overflow-x-hidden">
      ...
      <section id="portfolio" className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div id="portfolio-grid" className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            >
              ...
              <div className="mt-4">
                ...
                <Textarea
                  ...
                  className="min-h-[140px] border-white/10 bg-transparent text-white placeholder:text-white/50"
                />
              </div>
